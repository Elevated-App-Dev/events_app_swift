...
class SaveSystem: SaveSystemProtocol {
    ...
    func save(_ data: SaveData) {
        ...
        mutableData.lastSavedTime = Date()
    ...
    func load() -> SaveData? {
        ...
        do {
            ...
            if data.saveVersion != Self.currentVersion {
                ...
                data = migrateSaveData(data, fromVersion: data.saveVersion)
            }
    ...
    func migrateSaveData(_ data: SaveData, fromVersion version: String) -> SaveData {
        var migrated = data
